...
.subckt hwt vdd gnd A B C D Y
+ 

X_7_ A vdd gnd B C _2_ NAND3X1
XSFILL1520x100 vdd gnd FILL
X_10_ vdd gnd _4_ Y BUFX2
XSFILL1360x100 vdd gnd FILL
XSFILL1680x100 vdd gnd FILL
XSFILL3120x100 vdd gnd FILL
X_9_ gnd vdd _0_ _1_ _4_ _3_ AOI21X1
X_6_ vdd _1_ gnd B A NAND2X1
XSFILL3280x100 vdd gnd FILL
XSFILL2800x100 vdd gnd FILL
X_8_ vdd _3_ gnd D _2_ NAND2X1
X_5_ C _0_ vdd gnd INVX1
